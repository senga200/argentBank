...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await loginAction(store, { email: username, password, rememberMe }); // appel de loginAction -> on recupere le username et password saisis par l'utilisateur et le store en paramètre pour pouvoir accéder au dispatch et au state du store dans loginAction (voir loginAction.js) et donc à l'objet token qui est dans le state du store (voir loginReducer.js)
      navigate("/user");
    } catch (err) {
